...
### 2. packages/llm/src/__tests__/kimi-provider.test.ts (4 occurrences)
...
### 3. packages/llm/src/__tests__/templates.test.ts (line 11)
```diff
- model: 'kimi-k2-0711',
+ model: 'kimi-k2.5',
```

### 4. packages/llm/src/__tests__/structured-output.test.ts (line 11)
```diff
- model: 'kimi-k2-0711',
+ model: 'kimi-k2.5',
```

### 5. packages/llm/src/__tests__/gateway.test.ts (line 10)
```diff
- model: 'kimi-k2-0711',
+ model: 'kimi-k2.5',
```
