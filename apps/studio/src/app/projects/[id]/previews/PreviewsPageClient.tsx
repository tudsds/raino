  ...
  return (
    <div className="min-h-screen bg-[#0A1929]">
          ...
          <div className="flex items-center gap-4">
            ...
            {hasPlaceholder && (
              <button
                ...
                className="glass-surface px-4 py-2 text-sm text-[#1565C0] hover:text-white hover:border-[#1565C0] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        {designMessage && (
          <div
            className={`mb-4 px-4 py-3 text-sm font-[family-name:var(--font-body)] glass-surface ${
              designMessage.type === 'success'
                ? 'border border-[#4CAF50] text-[#4CAF50]'
                : 'border border-[#EF5350] text-[#EF5350]'
            }`}
          >
            {designMessage.text}
          </div>
        ...
        <div className="glass-elevated overflow-hidden">
          <div className="border-b border-white/[0.12] px-6 py-4">
