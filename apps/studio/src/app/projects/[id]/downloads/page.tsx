...
export default function DownloadsPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <div
 key={file.id}
 className="p-4 flex items-center justify-between hover:bg-[#132F4C]/50 transition-colors"
 >
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 bg-[#132F4C] border border-[#1E3A5F] flex items-center justify-center">
 ...
 className="px-4 py-2 bg-[#132F4C] border border-[#1E3A5F] text-[#E2E8F0] text-sm hover:border-[#1565C0] hover:text-[#1565C0] transition-colors flex items-center gap-2"
 >
 <svg
 className="w-4 h-4"
 fill="none"
 ...
 <span className="text-[#f59e0b] font-[family-name:var(--font-body)]">Placeholder</span>
 </div>
 )}
 </div>
 </div>
