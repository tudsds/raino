      ...
      <div className="min-h-screen bg-[#0A1929]">
        <header className="border-b border-white/[0.12] bg-[#0A1929]/80 backdrop-blur-xl sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
            <Link href={`/projects/${id}`} className="text-[#94A3B8] hover:text-[#E2E8F0] transition-colors">
            ...
            <div>
              ...
              <p className="text-xs text-[#94A3B8]">{id}</p>
            </div>
          </div>
        </header>
        <main className="max-w-7xl mx-auto px-6 py-16">
          <div className="glass-surface p-8 text-center max-w-lg mx-auto">
            <div className="w-16 h-16 mx-auto mb-6 glass-blue-tint flex items-center justify-center rounded-full">
              <svg className="w-8 h-8 text-[#6191D3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h2 className="text-xl font-semibold text-[#E2E8F0] mb-3">Database Unavailable</h2>
            <p className="text-[#94A3B8] mb-4">Project data could not be loaded. The specification panel requires a database connection.</p>
