...
export default async function BOMPage({ params }: BOMPageProps) {
 ...
 <tr key={item.id}>
 <td className="font-[family-name:var(--font-body)] text-[#1565C0]">{item.ref}</td>
 <td>{item.value}</td>
 <td className="font-[family-name:var(--font-body)] text-sm">{item.mpn}</td>
 <td>{item.manufacturer}</td>
 <td className="text-right font-[family-name:var(--font-body)]">{item.quantity}</td>
 <td className="text-right font-[family-name:var(--font-body)]">
 ${Number(item.unit_price).toFixed(2)}
 </td>
 <td className="text-right font-[family-name:var(--font-body)] text-[#E2E8F0]">
 ...
 <td colSpan={6} className="text-right font-semibold text-[#E2E8F0]">
 Total (estimated):
 </td>
 <td className="text-right font-[family-name:var(--font-body)] text-lg font-bold text-[#1565C0]">
 ${totalCost.toFixed(2)}
 </td>
 <td></td>
 </tr>
 ...
 <div className="bg-white/[0.06] backdrop-blur-xl border border-white/[0.12] rounded-xl p-4">
