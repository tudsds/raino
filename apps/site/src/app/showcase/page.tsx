...
function ProjectCard({ project, index }: { project: (typeof projects)[0]; index: number }) {
 ...
 <div className="aspect-video bg-white/[0.06] backdrop-blur-xl border border-white/[0.12] rounded-xl p-6 flex items-center justify-center relative overflow-hidden">
