					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
							...
							{gettingStartedSteps.map((step, index) => (
								...
								>
									<div className="relative z-10">
										...
										<div className="glass-surface p-3 font-[family-name:var(--font-body)] text-sm text-[#1565C0] overflow-x-auto">
											{step.command}
										</div>
									</div>
								</div>
						...
						<div className="mt-12 text-center">
							...
							<a
								...
								className="inline-flex items-center gap-2 glass-surface px-6 py-3 text-[#E2E8F0] font-semibold"
							>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							{docSections.map((section) => (
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									className="group glass-surface glass-specular p-6"
								>
									<div className="relative z-10">
