          ...
          <div className="space-y-6">
            {commitments.map((commitment, index) => (
              <div
                ...
                className="p-8 bg-white/[0.06] backdrop-blur-xl border border-white/[0.12] rounded-xl"
              >
      ...
      <section className="py-24 bg-[#0A1929]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-white/[0.06] backdrop-blur-xl border border-white/[0.12] text-[#E2E8F0] font-semibold rounded-xl hover:bg-white/[0.10] hover:border-white/[0.20] transition-all duration-300"
          >
