...
function StepNode({
 ...
 <div
 className={`p-6 bg-white/[0.06] backdrop-blur-xl border border-white/[0.12] rounded-xl hover:bg-white/[0.10] hover:border-white/[0.20] transition-all duration-300 ${align === 'right' ? 'ml-auto' : 'mr-auto'}`}
 ...
 <div
 className="flex-1 p-5 bg-white/[0.06] backdrop-blur-xl border border-white/[0.12] rounded-xl hover:bg-white/[0.10] hover:border-white/[0.20] transition-all duration-300 mb-6"
 >
 <div className="flex items-center gap-3 mb-3">
 <span className="text-2xl">{step.icon}</span>
 <span
